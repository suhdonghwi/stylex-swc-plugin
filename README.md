...
npm install --save-dev @stylexswc-toss/nextjs-plugin

# For other build tools
npm install --save-dev @stylexswc-toss/unplugin
```
...
```javascript
// next.config.js
const stylexPlugin = require('@stylexswc-toss/nextjs-plugin');
...
| -------------------- | -------------------------------- | -------------------------- |
| Next.js              | `@stylexswc-toss/nextjs-plugin`  | 🚀 Native SWC Integration  |
| Vite                 | `@stylexswc-toss/unplugin`       | ⚡ Lightning Fast HMR      |
| Webpack              | `@stylexswc-toss/unplugin`       | 🔧 Seamless Integration    |
| Rollup               | `@stylexswc-toss/unplugin`       | 📦 Optimized Bundling      |
| Jest                 | `@stylexswc-toss/jest`           | 🧪 Reliable Testing        |
| PostCSS              | `@stylexswc-toss/postcss-plugin` | 🎨 CSS Pipeline Ready      |
| Rspack               | `@stylexswc-toss/unplugin`       | 🚀 Rust-Powered Speed      |
| Farm, Rsbuild, Solid | `@stylexswc-toss/unplugin`       | 🌟 Modern Build Experience |
