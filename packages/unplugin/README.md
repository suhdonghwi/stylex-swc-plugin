...
```ts
// rollup.config.js
import StylexRsPlugin from '@stylexswc-toss/unplugin/rollup';
...
module.exports = {
  /* ... */
  plugins: [
    require('@stylexswc-toss/unplugin/webpack')({
      /* options */
    }),
  ],
};
...
import StylexRsPlugin from '@stylexswc-toss/unplugin/esbuild';
