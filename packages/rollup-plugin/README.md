...
```bash
npm install --save-dev @stylexswc-toss/webpack-plugin
```

Please install `@stylexswc-toss/rs-compiler` if you haven't done so already:
...
```js
const StylexPlugin = require('@stylexswc-toss/webpack-plugin');
