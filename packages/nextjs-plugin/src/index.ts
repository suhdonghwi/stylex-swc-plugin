...
import StyleXWebpackPlugin, { VIRTUAL_CSS_PATTERN } from '@tossteam/stylexswc-webpack-plugin';

import type { NextConfig, WebpackConfigContext } from 'next/dist/server/config-shared';
import type { StyleXPluginOption } from '@tossteam/stylexswc-webpack-plugin';
