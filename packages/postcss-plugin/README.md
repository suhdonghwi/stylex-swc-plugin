...
```bash
npm install --save-dev @stylexswc-toss/postcss-plugin
```
...
> [!WARNING] Each plugin of `@stylexswc-toss` namespace accepts an `extractCSS`
...
> behavior when using `NextJS`, use the regular `@stylexswc-toss/nextjs-plugin`
